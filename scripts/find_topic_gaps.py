...
STOPWORDS = {
    ...
    # 2026-09-08 보강 — 어미·활용형이 "MCP에 없는 키워드"로 잡혀 신호를 덮었다.
    # 150개 기준 상위 14개 중 9개가 이런 말이었다(궁금합니다·되나요·중인데 등).
    "궁금합니다", "계실까요", "되나요", "중인데", "진행중", "가능한가요", "대상인가요",
    "심사에서", "하는데", "하려는데", "해야하나요", "어떻게", "무엇인가요", "뭔가요",
    "드려요", "드립니다", "부탁드려요", "알려주세요", "해주세요", "봐주세요",
    "이신분", "하신분", "가신분", "받으신분", "계신가요", "인가요", "일까요", "겠죠",
    "공유합니다", "공유드려요", "후기", "정리", "총정리", "방법", "관하여", "대하여",
}
